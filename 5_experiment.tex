...
\vspace{-0.3in}
\centering
  \subfigure[Orthogonal Error of Singular Vectors]
  {
    \includegraphics[width=0.4\textwidth,height=1in]{ortho_err}
    \label{fig:svd_val}
  }
  \subfigure[Image of Multiplication of Singular Vectors]
  {
    \includegraphics[width=0.4\textwidth,height=1in]{orthogonal}
    \label{fig:svd_val_prof}
  }
\vspace{-0.1in}
