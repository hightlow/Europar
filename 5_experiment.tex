...
\centering
\includegraphics[width=2.2in]{compare_value_kernel}
\vspace{-0.1in}
...
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=2.2in]{transaction}
\vspace{-0.1in}
...
\centering
\includegraphics[width=1.5in]{tolerance}
\vspace{-0.1in}
...
\begin{minipage}[t]{0.33\linewidth}
\centering
\includegraphics[width=1.5in]{ortho_err}
\vspace{-0.1in}
...
\begin{minipage}[t]{0.33\linewidth}
\centering
\includegraphics[width=1.5in]{orthogonal}
\vspace{-0.1in}
...
The additional execution time is only less than $20 ms$ when matrix size is smaller than 12000, and $40 ms$ when matrix size is larger than 15000.
