...
\vspace{-0.3in}
\centering
  \subfigure[Comparison of Equal Length Division and Equal Number Division.]
  {
...
\vspace{-0.15in}
  \caption{Profiling Analysis of GPU Kernels}
%  \label{fig:ortho}
\vspace{-0.3in}
\end{figure}
%\begin{figure}[hbpt]
...
\begin{figure}[hbpt]
\centering
  \subfigure[Average Extra Execution Time When the accuracy increase Performance Comparision]
  {
    \includegraphics[width=0.3\textwidth]{tolerance}
    \label{fig:tolerance}
  }
  \subfigure[Orthogonal Error]
  {
    \includegraphics[width=0.3\textwidth]{ortho_err}
    \label{fig:ortho_err}
  }
  \subfigure[Image of Singular Vector Multiplication]
  {
    \includegraphics[width=0.3\textwidth]{orthogonal}
    \label{fig:ortho_img}
  }
