...
With our carefully designed GPU kernels, the BT algorithm takes only 0.8 second to obtain all the singular values and vectors on a GeForce 750Ti for a single-precision matrix size of $10k$ by $10k$, and 1.5 seconds on Tesla K40c for a double-precision matrix of the same size.
This is about $10$ times faster than MKL divide-and-conquer routine DBDSDC on $8$ general purpose cores, and $36$ times faster than CULA QR routine DBDSQR on the same GPUs.
