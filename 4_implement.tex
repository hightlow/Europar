...
\vspace{-0.1in}
To obtain the singular values, we divide the whole interval {\color{red}containing all the singular values} into several subintervals, which can be computed in parallel. 
